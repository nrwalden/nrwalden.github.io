...
susp_travel = ind_proj_demo_calcSuspensionTravel(road_input, damping_ratio); % Estimated suspension travel (m)

% Aerodynamic Forces
[downforce, drag_force] = ind_proj_dem0_calcAerodynamics(air_density, frontal_area, ...
